...
\pagestyle{fancy}
\fancyhead[L]{\includegraphics[width=2.5cm]{logo-nclab.png}}
...
\begin{itemize}    
  ...
  \begin{itemize}
    ...
    \item 16:20 - 16:40 {W. Zhang}: {Parallel Solvers for Large Scale Sparse Linear Systems} % want to be before May 21
...
\begin{itemize}    
  ...
  \begin{itemize}
    ...
    \item 10:00 - 10:20 {M. Thomas}: {A Cyberinfrastructure-Based Computational Environment for the Unified Curvilinear Ocean Atmospheric Model (UCOAM)} 
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item 9:20 - 9:40 {M. Kuraz}: {An Application of the Schwarz Domain Decomposition Method on the Nonlinear Richards Equation Problem} % before Thursday
  ...
  \begin{itemize}
    ...
    \item 15:30 - 16:15 Pavel Karban: {\bf Agros2D} - Multiplatform C++ Application for the Solution of~Partial Differential Equations (PDE) Based on the Hermes Library 
    \item 16:15 - 17:00 Alberto Paoluzzi: {\bf PLaSM} - Programming Language of Solid Modeling
    \item 17:00 - 17:45 Mary Thomas: {\bf CyberWeb} - The Cyberinfrastructure Web Application Framework
  \end{itemize}
...
\item {\bf 9:00 - 10:20 Contributed Session I-A} (chairman D. Kuzmin) 
  ...
  \begin{itemize}
    ...
    \item 9:40 - 10:00 {S. Juntiwasarakij}: {Towards Crowdsourcing for Enterprise Innovation on Social Media Technology: The Social Technical Perspective} % want be on Thursday
  ...
  \begin{itemize}
    ...
    \item 9:20 - 9:40 {M. Aydogan}: {Some  Results on a Starlike  Log-harmonic Mappings of Order Alpha} % want be except 24th of May
    \item 9:40 - 10:00 {M. El-Borai}: {An Inverse Fractional Abstract Cauchy Problem With Nonlocal Conditions} 
    \item 10:00 - 10:20 {S. Chandrasekaran}: {A Minimum Sobolev Norm Numerical Technique for PDEs} % want be on Thursday or Friday
  \end{itemize}
  \item 10:20 - 10:40 Coffee break
  ...
  \begin{itemize}
    ...
    \item 11:20 - 11:40 {M. Bergander}: {Simulation of Fluid Flow Through a System of Chambers for Active Vibration Control of Rotating Structures.} % místo R.Rumin
  ...
  \begin{itemize}
    ...
    \item 11:20 - 11:40 {A. Sukul}: {Design and Development of Mobile Access for DSpace Open Source Institutional Repository on Hybrid Cloud Computing} % want be on Thursday
  ...
  \begin{itemize}
    ...
    \item 11:00 - 11:20 {S. Miller}: {Riemann Solutions for Spacetime Discontinuous Galerkin Methods}
    \item 11:20 - 11:40 {M. Zayernouri}: {Fractional Spectral Element Method}
    \item 11:40 - 12:00 {M. Aydogan}: {A Certain Class of Starlike Log-harmonic Mappings}
  \end{itemize}
  \item 12:00 - 14:00 Lunch break
  \item {\bf 14:00 - 17:45 Software Workshop}
  \begin{itemize}
    \item 14:00 - 14:45 Markus Blatt: {\bf DUNE} - The Distributed and Unified Numerics Environment
    ...
    \item 17:00 - 17:45 Florian Rudolf: {\bf ViennaMesh} - Highly Flexible Meshing Framework
  \end{itemize}
%  \item {\bf 14:00 - 15:00 Contributed Session III-A} (chairman J. Vorel) 
%  \begin{itemize}
%    \item 14:00 - 14:20 
%    \item 14:20 - 14:40 
%    \item 14:40 - 15:00 
%    \item 15:00 - 15:20  
%  \end{itemize}
%  \item {\bf 14:00 - 15:00 Contributed Session III-B} (chairman K. Wong) 
%  \begin{itemize}
%    \item 14:00 - 14:20 
%    \item 14:20 - 14:40 
%    \item 14:40 - 15:00 
...
\item {\bf 9:00 - 10:20 Contributed Session I-A} (chairman S. Miller) 
  ...
  \begin{itemize}
    ...
    \item 11:40 - 12:00 {S. Rahman}: {Regularity Criterion for 3D MHD Equations Passing Through the Porous Medium in Terms of Gradient Pressure} % want be on Thursday
  \end{itemize}
  \newpage
  ...
  \begin{itemize}
    ...
    \item 11:40 - 12:00 {B. Kalpakli} : {A High Resolution Interface Capturing Method With Discrete Conservation Equations for Compressible Multi-fluid Flows}
  \end{itemize}
...
% removed
%{P. Singh}: {Seismic Wave Attenuation Characteristics  From Coda Analysis in Garhwal Himalayas, India} % want be on Thursday
%{P. Singh}: {Mathematical Modeling of Ground Water Conditions Using Electrical Resistivity Method in Kaushambi Region, India} % want be on Thursday
