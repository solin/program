...
\item {\bf 9:00 - 10:20 Contributed Session I-A} (chairman D. Kuzmin) 
  \begin{itemize}
    ...
    \item 9:40 - 10:00 {P. Singh}: {Seismic Wave Attenuation Characteristics  From Coda Analysis in Garhwal Himalayas, India} % want be on Thursday
    \item 10:00 - 10:20 {M. Aydogan}: {Some  Results on a Starlike  Log-harmonic Mappings of Order Alpha} % want be except 24th of May
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item 11:20 - 11:40 {P. Singh}: {Mathematical Modeling of Ground Water Conditions Using Electrical Resistivity Method in Kaushambi Region, India} % want be on Thursday
  ...
  \begin{itemize}
    \item 14:00 - 14:20 {M. Zayernouri}: {Fractional Spectral Element Method}
    \item 14:20 - 14:40 {N. Hussen Al-Khalidy}: {Designing Betterf Buildings With Computational Fluid Dynamics Analysis}
    \item 14:40 - 15:00 {K. Alhussan}: {Smooth Particle Hydrodynamics of High Velocity Impact: Anti-meteorite Protection of Space Apparatuses of Normal Impact of Aluminium Ball on the Shield Made of Two Aluminium Screens}
%    \item 15:00 - 15:20  
  \end{itemize}
  \item {\bf 14:00 - 15:00 Contributed Session III-B} (chairman K. Wong) 
  \begin{itemize}
    \item 14:00 - 14:20 {S. K. Srivastava}: {Trigonometric Approximation of Periodic Functions Belonging to $Lip(\xi(t), P)$- Class}
    \item 14:20 - 14:40 {D. I. Papadimitriou}: {Bayesian Estimation of Turbulence Model Parameters Using High-Order Sensitivity Analysis}
    \item 14:40 - 15:00 {K. Nafa}: {Equal-Order Approximation of Coupled Stokes-Darcy Problems}
%    \item 15:00 - 15:20  
  \end{itemize}
%  \item 15:20 - 15:40 Coffee break
%  \item {\bf 15:40 - 17:00 Contributed Session IV-A} (chairman ) 
...
\item {\bf 9:00 - 10:20 Contributed Session I-A} (chairman S. Miller) 
  ...
  \begin{itemize}
    ...
    \item 11:40 - 12:00 {S. Chandrasekaran}: {A Minimum Sobolev Norm Numerical Technique for PDEs} % want be on Thursday or Friday
  \end{itemize}
%  \newpage
